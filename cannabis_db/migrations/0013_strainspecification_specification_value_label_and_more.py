# Generated by Django 4.2.2 on 2024-10-29 10:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cannabis_db', '0012_straindetailslistitems_sdlis_unique_id_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('positive', 'Positive'), ('negative', 'Negative'), ('generic', 'Generic'), ('neutrial', 'Neutrial')], max_length=50),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='strainspecification',
            name='title',
            field=models.CharField(blank=True, choices=[('thca', 'THCA '), ('tac', 'TAC '), ('cbda', 'CBDA '), ('cbd', 'CBD'), ('cbg', 'CBG '), ('htcv', 'THCV '), ('thc', 'THC')], max_length=1000, null=True),
        ),
    ]
