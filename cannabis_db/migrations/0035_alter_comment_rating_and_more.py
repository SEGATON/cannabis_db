...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cannabis_db', '0034_alter_comment_rating_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='strainspecification',
            name='title',
            field=models.CharField(blank=True, choices=[('thc', 'THC'), ('thca', 'THCA '), ('tac', 'TAC '), ('cbd', 'CBD'), ('cbg', 'CBG '), ('cbda', 'CBDA '), ('htcv', 'THCV ')], max_length=1000, null=True),
        ),
    ]
