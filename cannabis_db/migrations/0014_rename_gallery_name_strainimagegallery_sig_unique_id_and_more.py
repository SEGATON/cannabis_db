# Generated by Django 4.2.2 on 2024-10-29 11:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cannabis_db', '0013_strainspecification_specification_value_label_and_more'),
    ]
    ...
    operations = [
        migrations.RenameField(
            ...
            new_name='sig_UNIQUE_ID',
        ),
        migrations.AlterField(
            model_name='comment',
            name='rating',
            field=models.CharField(choices=[('2', '2'), ('3', '3'), ('4', '4'), ('5', '5'), ('1', '1')], max_length=5),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('negative', 'Negative'), ('neutrial', 'Neutrial'), ('generic', 'Generic'), ('positive', 'Positive')], max_length=50),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='title',
            field=models.CharField(blank=True, choices=[('tac', 'TAC '), ('cbda', 'CBDA '), ('thca', 'THCA '), ('htcv', 'THCV '), ('cbd', 'CBD'), ('thc', 'THC'), ('cbg', 'CBG ')], max_length=1000, null=True),
        ),
    ]
