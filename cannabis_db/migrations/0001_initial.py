    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_address', models.CharField(choices=[('billing_address', 'Billing address'), ('shipping_address', 'Shipping address'), ('p_o_box_number', 'Post office box number'), ('physical_address', 'Physical Address')], max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.CharField(choices=[('4', '4'), ('1', '1'), ('2', '2'), ('3', '3'), ('5', '5')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_of_dispensary', models.CharField(blank=True, choices=[('Medical_recreational', 'Medical & Recreational'), ('medical', 'Medical'), ('recreational', 'Recreational')], max_length=50, null=True)),
                ('shopping_options', models.CharField(blank=True, choices=[('all', 'All'), ('pickup', 'Pickup'), ('delivery', 'Delivery')], max_length=50, null=True)),
                ('title', models.CharField(max_length=1000)),
                ('slug', models.SlugField(max_length=1000)),
                ('tagline', models.CharField(max_length=1000)),
                ('websiteURL', models.URLField(blank=True, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('strain_type_label', models.CharField(choices=[('hybrid', 'Hybrid'), ('indica', 'Indica'), ('sativa', 'Sativa')], max_length=70)),
                ...
                ('dispensary', models.ManyToManyField(blank=True, null=True, to='cannabis_db.dispensary')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, max_length=50, null=True)),
                ('slug', models.SlugField(blank=True, null=True)),
                ('strain_lineage_01', models.CharField(blank=True, choices=[('hybrid', 'Hybrid'), ('indica', 'Indica'), ('sativa', 'Sativa')], max_length=50, null=True)),
                ('strain_lineage_value_01', models.DecimalField(blank=True, decimal_places=2, max_digits=9, null=True)),
                ('strain_lineage_02', models.CharField(blank=True, choices=[('hybrid', 'Hybrid'), ('indica', 'Indica'), ('sativa', 'Sativa')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specification_name', models.CharField(choices=[('thca', 'THCA '), ('thc', 'THC'), ('cbg', 'CBG '), ('htcv', 'THCV '), ('tac', 'TAC '), ('cbd', 'CBD'), ('cbda', 'CBDA ')], max_length=1000)),
