    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.CharField(choices=[('5', '5'), ('4', '4'), ('2', '2'), ('3', '3'), ('1', '1')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_of_dispensary', models.CharField(blank=True, choices=[('medical', 'Medical'), ('medical_recreational', 'Medical & Recreational'), ('recreational', 'Recreational')], max_length=50, null=True)),
                ...
                ('accepted_payment_methods', models.CharField(choices=[('cash_debit_credit', 'Cash, Debit/Credit Cards'), ('debit_credit', 'Debit/Credit Cards'), ('cash', 'Cash')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strain_type_label', models.CharField(blank=True, choices=[('sativa', 'Sativa'), ('indica', 'Indica'), ('hybrid', 'Hybrid')], max_length=70, null=True)),
                ('title', models.CharField(max_length=50)),
                ('slug', models.SlugField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, choices=[('thc', 'THC'), ('htcv', 'THCV '), ('tac', 'TAC '), ('cbg', 'CBG '), ('cbda', 'CBDA '), ('thca', 'THCA '), ('cbd', 'CBD')], max_length=1000, null=True)),
