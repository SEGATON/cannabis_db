# Generated by Django 4.2.2 on 2024-01-08 01:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.CharField(choices=[('2', '2'), ('4', '4'), ('1', '1'), ('3', '3'), ('5', '5')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specification_name', models.CharField(choices=[('cbd', 'CBD'), ('thc', 'THC'), ('htcv', 'THCV '), ('cbg', 'CBG ')], max_length=1000)),
