# Generated by Django 4.2.2 on 2024-11-04 02:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cannabis_db', '0026_remove_terpenedetailslistset_terpene_set_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='terpenedetails',
            name='terpene_icon',
            field=models.ImageField(blank=True, default='media/CANNABIS_DB/STRAINS/TERPENES_REPORTS/TERPENE_ICONS/default.jpg/', max_length=500, null=True, upload_to='media/CANNABIS_DB/STRAINS/TERPENES_REPORTS/TERPENE_ICONS/'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='rating',
            field=models.CharField(choices=[('3', '3'), ('5', '5'), ('2', '2'), ('1', '1'), ('4', '4')], max_length=5),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='title',
            field=models.CharField(blank=True, choices=[('cbda', 'CBDA '), ('cbd', 'CBD'), ('cbg', 'CBG '), ('tac', 'TAC '), ('thca', 'THCA '), ('thc', 'THC'), ('htcv', 'THCV ')], max_length=1000, null=True),
        ),
    ]
