# Generated by Django 4.2.2 on 2024-01-18 22:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cannabis_db', '0012_dispensary_dispensary_brands_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='strain',
            name='dispensary',
            field=models.ManyToManyField(to='cannabis_db.dispensary'),
        ),
        ...
        migrations.AlterField(
            model_name='rating',
            name='rating',
            field=models.CharField(choices=[('3', '3'), ('1', '1'), ('4', '4'), ('2', '2'), ('5', '5')], max_length=5),
        ),
        migrations.AlterField(
            model_name='strain',
