...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cannabis_db', '0010_alter_dispensary_accepted_payment_methods_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='strainspecification',
            name='title',
            field=models.CharField(blank=True, choices=[('cbda', 'CBDA '), ('htcv', 'THCV '), ('thc', 'THC'), ('thca', 'THCA '), ('cbd', 'CBD'), ('cbg', 'CBG '), ('tac', 'TAC ')], max_length=1000, null=True),
        ),
    ]
