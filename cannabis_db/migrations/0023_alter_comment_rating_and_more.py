# Generated by Django 4.2.2 on 2025-02-03 20:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cannabis_db', '0022_remove_dispensary_date_submitted_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='strainspecification',
            name='title',
            field=models.CharField(blank=True, choices=[('tac', 'TAC '), ('cbd', 'CBD'), ('thc', 'THC'), ('cbda', 'CBDA '), ('thca', 'THCA '), ('cbg', 'CBG '), ('htcv', 'THCV ')], max_length=1000, null=True),
        ),
    ]
