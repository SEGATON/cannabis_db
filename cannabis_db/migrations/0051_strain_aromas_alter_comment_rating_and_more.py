# Generated by Django 4.2.2 on 2024-11-11 00:43
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cannabis_db', '0050_alter_comment_rating_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='strain',
            name='aromas',
            field=models.ManyToManyField(blank=True, null=True, to='cannabis_db.aromasdetails'),
        ),
        ...
        migrations.AlterField(
            model_name='strainspecification',
            name='title',
            field=models.CharField(blank=True, choices=[('tac', 'TAC '), ('thca', 'THCA '), ('cbd', 'CBD'), ('cbg', 'CBG '), ('cbda', 'CBDA '), ('thc', 'THC'), ('htcv', 'THCV ')], max_length=1000, null=True),
        ),
    ]
